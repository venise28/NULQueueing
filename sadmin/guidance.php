...
$sqlCompleted = "SELECT COUNT(*) AS completed_count FROM guidance WHERE status = 1";
...
$sqlPending = "SELECT COUNT(*) AS pending_count FROM guidance WHERE status = 0";
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-9 offset-3">
            <h4 class="fs-2 pt-5 ps-5 pb-2 nu_color text-start">GUIDANCE</h4>
            <hr>
                    ...
                    <div class="col-sm-3 mb-3" style="width: 18rem;">
                        <div class="card card-db">
                            <div class="card-body gap-3">
                                ...
                                <h2 class="mt-2 me-5  fw-bold nu_color float-end" id="guidance-count">
                                    ...
                                </h2>
                    ...
                    <div class="col-sm-3 mb-3" style="width: 18rem;">
                        <div class="card card-db">
                            <div class="card-body gap-3">
                                ...
                                <h2 class="mt-2 me-5  fw-bold nu_color float-end" id="completed-guidance-count">
                    ...
                    <div class="col-sm-3 mb-3" style="width: 18rem;">
                        <div class="card card-db">
                            <div class="card-body gap-3">
                                ...
                                <h2 class="mt-2 me-5  fw-bold nu_color float-end" id="pending-guidance-count">
