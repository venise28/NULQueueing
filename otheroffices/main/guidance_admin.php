...
<head>
  ...
  <p class="profile-window" style="color: black;"> <?php echo $_SESSION["window"]; ?></p>
</div>
...
<script>
  ...
  <div class="main">
    ...
    $sql = "SELECT queue_number, student_id, remarks, transaction, timestamp, endorsed_from FROM guidance";
...
<div class="modal" id="endorseModal">
  <div class="center-container">
    <div class="f-modal">
      ...
      <form action="guidance_submit_endorsed_data.php" method="post">
...
function openEndorseModal() {
 ...
 $sql = "SELECT queue_number FROM guidance";
 $result = $conn->query($sql);
 ...
 xhr.open('GET', 'guidance_fetch_queue_data.php?queueNumber=' + queueNumber, true);
 xhr.send();
}
