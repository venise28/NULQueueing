...
$updateQuery = "UPDATE itso SET window = '$windowNumber' WHERE queue_number = '$queueNumber'";
$result = $conn->query($updateQuery);

// Fetch the current window number
$currentWindowQuery = "SELECT window FROM itso WHERE queue_number = '$queueNumber'";
...
if ($currentWindowResult) {
    if ($currentWindowResult->num_rows > 0) {
        ...
        $updateDisplayQuery = "INSERT INTO display (queue_number, window, officeName) VALUES ('$queueNumber', '$currentWindow', 'ITSO')
