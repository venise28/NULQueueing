...
<script>
  ...
  <div class="main">
    ...
    $sql = "SELECT queue_number, student_id, remarks, transaction, timestamp, endorsed_from FROM assets";
...
<div class="modal" id="endorseModal">
  <div class="center-container">
    <div class="f-modal">
      ...
      <form action="assets_submit_endorsed_data.php" method="post">
...
<div class="form-group">
  ...
  if (queueNumber && windowNumber) {
    ...
    xhr.open('POST', 'AssetsUpdateWindow.php', true);
...
<script>
  ...
  location.reload();
    ...
    if (queueNumber) {
        ...
        xhr.open('POST', 'assets_end_transaction.php', true);
        xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
function openEndorseModal() {
 ...
 $sql = "SELECT queue_number FROM assets";
 $result = $conn->query($sql);
 ...
 xhr.open('GET', 'assets_fetch_queue_data.php?queueNumber=' + queueNumber, true);
 xhr.send();
}
