...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['office'])) {
    ...
    $sqlUpdateEndorsedTo = "UPDATE guidance SET endorsed_to = '$formattedSelectedOffice' WHERE queue_number = '$selectedQueueNumber'";
    ...
    $sqlUpdateStatus = "UPDATE guidance SET status = 1 WHERE queue_number = '$selectedQueueNumber'";
...
<head>
    ...
    <title>NU Guidance Office</title>
