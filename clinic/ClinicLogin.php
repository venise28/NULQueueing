...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM user_accounts WHERE username = '$username' AND password = '$password' AND office = 'Clinic'";
    ...
    if ($result->num_rows == 1) {
        ...
        header('Location: ClinicHome.php'); // Redirect to a dashboard page
    } else {
        // Invalid credentials or wrong office
        $message = "Login failed. Please check your username, password, or office.";
        echo '<script>alert("' . $message . '"); window.location.href="ClinicLogin.php";</script>';
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8 p-5">
                <h4 class="fst-italic fs-3 p-5 fw-bold text-center nu_color">Clinic Office.</h4>
              
<!-- log in page goes here-->

<div class="login">
    <form id="login" method="post" action="ClinicLogin.php">
