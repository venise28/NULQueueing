...
<body>
    <div class="main-container">
        ...
        <div class="registrar-container araa-office">
            ...
            <ul id="registrar-queue-list">
                <!-- The queue numbers will be dynamically updated here using JavaScript -->
            </ul>
        </div>
    ...
    <script>
           function updateRegistrarQueue() {
            // Use AJAX to fetch the latest data from the server
            $.ajax({
                url: 'get_registrar_queue.php', // Create a separate PHP file to handle database query
                method: 'GET',
                success: function (data) {
                    // Update the content of the ul element with the received data
                    $('#registrar-queue-list').html(data);
                },
                complete: function () {
                    // Set a timeout to call the function again after 3 seconds
                    setTimeout(updateRegistrarQueue, 3000);
                }
            });
        }
