...
<body>
    <div class="col-3 blue-bg position-fixed p-0 container">
                    ...
                    <div class="offset-md-2 d-none d-lg-block">
                        <a href="dashboard.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-start"><i
                                class="fa-lg bi bi-columns-gap text-light pe-2"></i>
                ...
                <div class="fs-5 row g-0 dashboard-bg position-relative p-4 " style="width: 100%;">
                    <div class="col-md-2 offset-md-2 d-none d-lg-block">
                        <a href="users.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-start"><i
                                class="fa-lg bi bi-people-fill text-light pe-2"></i>
                ...
                <div class="offices-container fs-5 row g-0  position-relative" style="width: 100%;">
                    <div class=" d-none d-lg-block dropdown-container">
                        ...
                        <ul class="dropdown-content offset-md-2" id="myDropdown">
                            ...
                            <li class="pt-1"><a href="other-offices.php" id="other-offices-link" class="fw-bold text-light text-decoration-none">OTHER OFFICES</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="d-lg-none">
                        <a href="#"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-center"><i
                                class="fa-lg bi bi-buildings text-light pe-2"></i></a>
                    </div>
                </div>
                ...
                <div class="fs-5 row g-0 dashboard-bg position-relative p-4 " style="width: 100%;">
                    <div class="col-md-2 offset-md-2 d-none d-lg-block">
                        <a href="report.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-start"><i
                                class="fa-lg bi bi-clipboard-data-fill text-light pe-2"></i>
                    ...
                    <div class="d-lg-none">
                        <a href="report.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-center"><i
                                class="fa-lg bi bi-clipboard-data-fill text-light pe-2"></i></a>
                    </div>
                </div>
                ...
                <div class="fs-5 row g-0 dashboard-bg position-relative p-4 mt-auto" style="width: 100%;">
                    <div class="col-md-2 offset-md-2 d-none d-lg-block">
                        <a href="logout.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-start"><i
                                class="fa-lg bi bi-box-arrow-in-right text-light pe-2"></i>
                    ...
                    <div class="d-lg-none">
                        <a href="logout.php"
                            class="stretched-link text-decoration-none text-light fw-bold d-flex justify-content-center"><i
                                class="fa-lg bi bi-box-arrow-in-right pe-2"></i></a>
                    </div>
                </div>
    ...
    <script>
        ...
        // Close the dropdown if the user clicks outside of the button and the dropdown
        // window.onclick = function(event) {
        //     var dropdown = document.getElementById("myDropdown");
        //     var button = document.querySelector(".dropbtn");
        //     if (event.target !== button && event.target !== dropdown && !dropdown.contains(event.target)) {
        //         dropdown.style.display = "none";
        //     }
        // }
    </script>
