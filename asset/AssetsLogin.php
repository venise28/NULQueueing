...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM user_accounts WHERE username = '$username' AND password = '$password' AND office = 'Assets'";
    ...
    if ($result->num_rows == 1) {
        ...
        header('Location: AssetsHome.php'); // Redirect to a dashboard page
    } else {
        // Invalid credentials or wrong office
        $message = "Login failed. Please check your username, password, or office.";
        echo '<script>alert("' . $message . '"); window.location.href="AssetsLogin.php";</script>';
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8 p-5">
                <h4 class="fst-italic fs-3 p-5 fw-bold text-center nu_color">Assets Office.</h4>
              
<!-- log in page goes here-->

<div class="login">
    <form id="login" method="post" action="AssetsLogin.php">
