...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['office'])) {
    ...
    $sqlUpdateEndorsedTo = "UPDATE assets SET endorsed_to = '$formattedSelectedOffice' WHERE queue_number = '$selectedQueueNumber'";
    ...
    $sqlUpdateStatus = "UPDATE assets SET status = 1 WHERE queue_number = '$selectedQueueNumber'";
